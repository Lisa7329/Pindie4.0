...
const { findAllCategories, createCategory, findCategoryById, updateCategory, deleteCategory, checkIsCategoryExists, checkEmptyName, checkAuth } = require('../middlewares');
...
categoriesRouter.delete("/games/:id",
    checkAuth,
    deleteCategory,
    sendCategoryDeleted
);
